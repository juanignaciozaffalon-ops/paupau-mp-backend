...
// Borrar horario (si no está pagado)
...
/* === Cambiar estado manualmente (Disponible / Pendiente / Bloqueado) === */
app.post('/admin/horarios/:id/estado', requireAdmin, async (req, res) => {
  ...
  try {
    ...
    // Si queremos disponible: cancelar pendientes / bloquear borrado admin
    ...
    // Cancelar pendientes previas para re-crear el estado que pide el admin
    await pool.query(
